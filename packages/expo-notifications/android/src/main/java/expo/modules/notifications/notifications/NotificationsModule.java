...
public class NotificationsModule extends ExportedModule implements NotificationListener {
  private final static String EXPORTED_NAME = "ExpoNotificationsModule";

  private final static String NEW_MESSAGE_EVENT_NAME = "onWillPresentNotification";
   ...
   * Emits a {@link NotificationsModule#NEW_MESSAGE_EVENT_NAME} event.
   *
   ...
   * Emits a {@link NotificationsModule#MESSAGES_DELETED_EVENT_NAME} event.
   */
  @Override
